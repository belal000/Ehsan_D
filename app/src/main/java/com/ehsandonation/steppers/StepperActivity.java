package com.ehsandonation.steppers;
...
import com.ehsandonation.utils.IndicatorViewPagerAdapter;
...
public class StepperActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        indicatorViewPagerAdapter = new IndicatorViewPagerAdapter(context, layouts);
        viewPager.setAdapter(indicatorViewPagerAdapter);
     ...
     */
    private void initializationLayouts() {
        layouts = new int[]{
    ...
    /**
     * Checking for medical time launch - before calling setContentView()
     */
    private void checkFirstTimeLunch() {
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(StepperActivity.this, MainActivity.class));
        finish();
    }
